    ...
    <div className="space-y-8">
      ...
      <section className="space-y-4">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="rounded-lg border bg-white/70 p-4 dark:bg-neutral-900/60 dark:text-gray-200">
            <p className="text-sm">
              This block uses <span className="font-mono">dark:</span> variants. Switch your system theme to see
              changes.
            </p>
          </div>
      ...
      <section className="space-y-4">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          <button className="rounded-lg bg-white px-4 py-3 text-sm font-medium shadow-lg shadow-indigo-500/50">
            Indigo Shadow
          </button>
          <button className="rounded-lg bg-white px-4 py-3 text-sm font-medium shadow-lg shadow-cyan-500/50">
            Cyan Shadow
          </button>
          <button className="rounded-lg bg-white px-4 py-3 text-sm font-medium shadow-xl shadow-blue-500/50">
            Blue Shadow
          </button>
        </div>
        <div className="grid sm:grid-cols-3 gap-4">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="group [perspective:1000px]">
            <div className="relative h-40 w-full rounded-xl border bg-white [transform-style:preserve-3d] transition-transform duration-500 group-hover:[transform:rotateY(180deg)]">
              <div className="absolute inset-0 flex items-center justify-center rounded-xl bg-indigo-50 text-indigo-700 [backface-visibility:hidden]">
                Front
              </div>
              <div className="absolute inset-0 flex items-center justify-center rounded-xl bg-pink-50 text-pink-700 [transform:rotateY(180deg)] [backface-visibility:hidden]">
                Back
              </div>
            </div>
